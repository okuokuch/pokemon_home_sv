...
response = requests.get(url.format(cid=parameters["cid"], rst=parameters["rst"], ts=parameters["ts2"]))

response_detail = requests.get(url_2.format(cid=parameters["cid"], rst=parameters["rst"], ts=parameters["ts2"], num=1))
